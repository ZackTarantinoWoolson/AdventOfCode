...
Start: 7:27 PM ET 12/5
Finished  

Result needed: 
Lowest location number based on an initial seed. Seeds are now ranges. so we have two ranges.

Tasks:
- Rewrite initial seed set to check for ranges
- Should be able to run the rest as the same in part 1?