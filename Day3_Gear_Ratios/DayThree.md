...
Tasks:
- Modify the search to only look for *
- add a condition to check for number of numbers found around the gear (count top, inline, and bottom before summation)
- Add calculation for product and summation 